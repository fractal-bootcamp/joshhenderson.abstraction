...
const map2 = (funk, arr: number[]): number[] => {
    return arr.map((e) => { return funk(e) })
}
...
const double_and_add_three = (x) => { return x * 2 + 3 }
...
const sumReducer2 = (accumulator, element) => { return accumulator + element }
